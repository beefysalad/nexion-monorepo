          ...
          <CardContent>
            <FieldGroup>
              <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
                <Avatar className="size-20 border-2 border-background shadow-sm" size="lg">
                  {user.imageUrl ? (
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <Field>
                  ...
                  <Input id="settings-name" defaultValue={user.name} placeholder="Your name" />
                </Field>
                <Field>
